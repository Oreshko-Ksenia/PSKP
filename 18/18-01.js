    ...
    if (req.method === 'GET' && pathname === '/') {
        ...
        switch (path) {
            ...
            case 'api/teachers':
                ...
                service.getHandler(req, res, database.getTeachers);
                break;
            ...
            case 'api/auditoriums':
                ...
                break;
            case 'api/auditoriumsbetween':
                console.log('GET api/auditoriumsbetween');
                service.getHandler(req, res, database.getAuditoriumsBetween10And60);
                break;
            case 'api/faculty':
                console.log(`GET api/faculty/${codeParameter}/${additionalParameter}`);
                if (codeParameter === undefined || additionalParameter === undefined || additionalParameter !== "subjects") {
                    service.errorHandler(res, 400, 'Invalid parameters');
                } else {
                    service.getHandler(req, res, database.getSubjectsByFaculty, codeParameter);
                }
                break;
        ...
        switch (path) {
            ...
            case 'api/teachers':
                ...
                service.workWithTeacher(req, res, database.insertTeachers);
                break;
            case 'api/auditoriumstypes':
        ...
        switch (path) {
            ...
            case 'api/subjects':
                ...
                break;
            case 'api/teachers':
                console.log('PUT api/teachers');
                service.workWithTeacher(req, res, database.updateTeachers);
                break;
            case 'api/auditoriumstypes':
        ...
        switch (path) {
            ...
            case 'api/subjects':
                ...
                break;
            case 'api/teachers':
                console.log('DELETE api/teachers');
                service.deleteHandler(req, res, database.deleteTeacher, codeParameter);
                break;
            case 'api/auditoriumstypes':
